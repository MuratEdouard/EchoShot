	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float3 break88 = input.positionOS.xyz;
				float3 appendResult89 = (float3(break88.x , 0.0 , break88.z));
				float4 transform90 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float4 appendResult71 = (float4(input.ase_color.b , input.ase_color.r , input.ase_color.g , input.ase_color.a));
				...
				float4 normalizeResult11_g29 = normalize( input.ase_color );
				...
				float3 rotatedValue24 = RotateAroundAxis( float3( 0,0,0 ), input.positionOS.xyz, normalize( float3( 0,1,0 ) ), ( ( simplePerlin2D4_g29 / 2.0 ) * _SwayAmount ) );
				float3 SubtleWind92 = ( ( float3(0,1,0) * distance( appendResult89 , float3( 0,0,0 ) ) * _BounceAmount * ( simplePerlin2D4_g30 / 2.0 ) ) + ( rotatedValue24 - input.positionOS.xyz ) );
						 ...
						 ) : SV_Target
			{
				...
				float clampResult33 = clamp( ( ( input.ase_texcoord10.xyz.y - _GradientOffset ) * _GradientSmoothness ) , 0.0 , 1.0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float4 tex2DNode45 = tex2D( _Texture, uv_Texture );
				clip( tex2DNode45.a - _AlphaClip);
				float clampResult33 = clamp( ( ( input.ase_texcoord5.xyz.y - _GradientOffset ) * _GradientSmoothness ) , 0.0 , 1.0 );
				float SunDirection39 = clampResult33;
				float4 lerpResult48 = lerp( _BottomColor , _TopColor , SunDirection39);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float4 tex2DNode45 = tex2D( _Texture, uv_Texture );
				clip( tex2DNode45.a - _AlphaClip);
				float clampResult33 = clamp( ( ( input.ase_texcoord3.xyz.y - _GradientOffset ) * _GradientSmoothness ) , 0.0 , 1.0 );
				float SunDirection39 = clampResult33;
				float4 lerpResult48 = lerp( _BottomColor , _TopColor , SunDirection39);
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;132;27.06811,63.67464;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=78F443B86F9E435367B354E95F34CB7D645DB274